...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"get_expert_review_record_list?t="+new Date().getTime(),
	        idField:'id', 
	        ...
	        remoteSort: true,
	        columns: [[  
	        	{field:'expert_review_id',title:'专家审核记录ID',width:100,sortable:true},
        		{field:'manuscript_id',title:'稿件ID',width:50},
        		{field:'expert_id',title:'专家ID',width:50},
        		{field:'expert_opinion',title:'专家审核结果',width:100},
        		{field:'expert_opinion_value',title:'专家意见',width:300},
        		{field:'expert_review_time',title:'操作时间',width:150}
	 			]],
	        toolbar: "#toolbar"
	    }); 
