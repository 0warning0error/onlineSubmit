	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
	        		...
	        		{field:'id',title:'编辑ID',width:50,sortable:true},
	        		{field:'username',title:'用户名',width:150},
	        		{field:'password',title:'密码',width:150},
	        		{field:'name',title:'编辑姓名',width:100},
...
<body>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<div style="position:absolute;right:70px;top:28px;z-index:999;"><a id="edit" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true">修改</a></div>
	</div>
	<!-- 修改窗口 -->
	<div id="editDialog" style="padding: 10px">
    	<form id="editForm" method="post">
	    	...
	    	<table id="editTable" border=0 cellpadding="8" >
	    		...
	    		<tr>
	    			<td>姓名:</td>
	    			<td><input id="name" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="name" data-options="required:true, missingMessage:'请填写姓名'"  /></td>
	    		</tr>
	    		<tr>
	    			<td>性别:</td>
	    			<td>
