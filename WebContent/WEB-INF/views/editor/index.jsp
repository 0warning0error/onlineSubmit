    ...
    var _menus = {"menus":[
            {"menuid":"1","icon":"","menuname":"稿件信息管理",
                "menus":[
                    ...
                    {"menuid":"13","menuname":"专家审稿记录","icon":"icon-large-clipart","url":"./editor/queryExpertReviewRecord"}
                ]
            },
            ...
            {"menuid":"3","icon":"","menuname":"用户信息管理",
                "menus":[
                    {"menuid":"31","menuname":"作者信息","icon":"icon-user-student","url":"./editor/queryUserInfo"},
