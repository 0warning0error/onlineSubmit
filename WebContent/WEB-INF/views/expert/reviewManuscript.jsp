	  ...
	  //审核稿件
	  	$("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				$("#ok").click(function() {
					var opinion_value = document.getElementById("opinion").value;
					console.log(opinion_value + "hello");
					$("#ok").attr("href","../expert/review?flag=true&manuscript_id="+selectRow.manuscript_id+"&opinion="+opinion_value);
				})
				$("#no").click(function() {
					var opinion_value = document.getElementById("opinion").value;
					console.log(opinion_value + "hello");
					$("#no").attr("href","../expert/review?flag=false&manuscript_id="+selectRow.manuscript_id+"&opinion="+opinion_value);
				})
	...
	<div id="editDialog" style="padding: 10px;position:relative;">
    	<form id="editForm" method="post">
	    	...
	    	<table id="editTable" border=0 cellpadding="10" >
	    		...
	    		<tr><td>专家意见:</td><td><textarea id="opinion" rows="8" cols="50" name="summary"></textarea></td></tr>
	    		<tr>
	    			<td></td>
