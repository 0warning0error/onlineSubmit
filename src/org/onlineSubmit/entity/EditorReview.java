...
public class EditorReview {
	...
	private String editor_opinion_value;//编辑复审意见
	public String getEditor_opinion_value() {
		return editor_opinion_value;
	}
	public void setEditor_opinion_value(String editor_opinion_value) {
		this.editor_opinion_value = editor_opinion_value;
	}
