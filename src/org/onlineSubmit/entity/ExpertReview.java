...
public class ExpertReview {
	...
	public String getExpert_opinion_value() {
		return expert_opinion_value;
	}
	public void setExpert_opinion_value(String expert_opinion_value) {
		this.expert_opinion_value = expert_opinion_value;
	}
	private String expert_opinion_value;//专家审核意见
